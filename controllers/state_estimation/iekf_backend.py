...
class IEKFState:
    ...
    def heading(self) -> float:
        """"
        Heading in world frame (radians).
...
class IEKFBackend:
    ...
    def __init__(
        ...
        ----------
        init_pos : np.ndarray
            Initial position (x, y) in world frame.
        init_heading : float
            Initial heading in world frame (radians).
        sigma_pos : float
            Initial position uncertainty (standard deviation).
        sigma_heading : float
            Initial heading uncertainty (standard deviation).
        sigma_vel : float
            Initial velocity uncertainty (standard deviation).
        sigma_gyro_bias : float
            Initial gyro bias uncertainty (standard deviation).
        sigma_accel_bias : float
            Initial accelerometer bias uncertainty (standard deviation).
        sigma_gyro : float
